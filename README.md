...
A professional-grade Monte Carlo simulation engine for stock price modeling and options pricing using Geometric Brownian Motion (GBM). This terminal provides comprehensive analysis tools, advanced variance reduction techniques, and extensive diagnostic capabilities for quantitative finance applications.

**[View Visualization Gallery](plotly.md)** - See examples of all interactive charts and dashboards generated by the terminal.
